...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters( 'woocommerce_lost_password_message', esc_html__( 'Type your email and we’ll send you a link to recover your password', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
