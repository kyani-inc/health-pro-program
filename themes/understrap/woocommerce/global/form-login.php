...
<div class="d-flex" id="customer_login">
	...
	<div class="p-5 w-50 checkout-half">
		<h2><?php esc_html_e('New to Nitro Nutrition?', 'woocommerce'); ?></h2>
		<h3><?php esc_html_e('Create An Account', 'woocommerce'); ?></h3>
		<h4><?php esc_html_e('Each time you shop, you\'ll be able to checkout more quickly!', 'woocommerce'); ?></h4>
		<form method="post"
			...
			<input type="text" class="d-none" id="reg_role" name="role" class="input" value="customer">
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit"
						class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit w-100"
						name="register"
	...
	<div class="p-5 w-50 checkout-half">
		...
		<h3><?php esc_html_e('Log Into Your Account', 'woocommerce'); ?></h3>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit w-100"
						name="login"
