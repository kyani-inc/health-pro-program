...
<form class="woocommerce-cart-form w-50 checkout-half p-3" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				?>
					...
					<td class="product-name cart-product-info-section" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
